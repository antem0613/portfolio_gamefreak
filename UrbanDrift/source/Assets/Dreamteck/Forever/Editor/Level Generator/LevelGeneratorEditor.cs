namespace Dreamteck.Forever.Editor
{
    ...
    public class LevelGeneratorEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            SerializedProperty IsActiveCity = serializedObject.FindProperty("IsActiveCity");
            SerializedProperty cityBlocks = serializedObject.FindProperty("cityBlocks");
            ...
            EditorGUILayout.PropertyField(IsActiveCity);
            EditorGUILayout.PropertyField (cityBlocks);
