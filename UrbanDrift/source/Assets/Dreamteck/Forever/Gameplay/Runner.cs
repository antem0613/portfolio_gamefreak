namespace Dreamteck.Forever
{
    ...
    public class Runner : MonoBehaviour
    {
        ...
        void DoUpdate()
        {
            ...
            else if(segment.segmentKind == 1)
            {
                float percent;
                _segment.Travel(_result.percent, _segment.CalculateLength() * 0.90f, Spline.Direction.Forward, out percent);
                GameManager.instance.limit = percent / 100f;
            }
