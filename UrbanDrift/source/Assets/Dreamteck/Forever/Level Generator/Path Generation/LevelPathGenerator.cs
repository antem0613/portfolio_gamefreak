...
namespace Dreamteck.Forever
{
    public class LevelPathGenerator : ScriptableObject
    {
        ...
        public virtual void Continue(LevelSegment segment)
        {
            ...
            lastPoint = segment.mainPath.spline.points[segment.mainPath.spline.points.Length - 1];
        ...
        public void GeneratePath(LevelSegment inputSegment)
        {
            ...
            {
                if (segment.previous.mainPath != null)
                {
                    points[0] = lastPoint;
                    pointStartIndex = 1;
                }
            ...
            segment.mainPath.spline = spline;
            segment.mainPath.sampleRate = sampleRate;
        }
