namespace Dreamteck.Forever
{
    ...
    public class ForeverLevel : ScriptableObject
    {
        ...
        public IEnumerator Load()
        {
            ...
            RemoteLevel[] remoteLevels = UnityEngine.Object.FindObjectsByType<RemoteLevel>(0);
        ...
        public LevelSegment[] InstantiateSegmentOnJunction(int branch)
        {
            SegmentSequence sequence = GetSequence();
            if (sequence == null)
            {
            ...
            SegmentDefinition definition = sequence.Next();
            LevelSegment[] definitions = new LevelSegment[branch]; 

            for (int i = 0; i < branch; i++)
            {
                definitions[i] = definition.Instantiate();
            }
